...
public class Client extends TestHarness {
    ...
    private void initSCCP() throws Exception {
        ...
        this.sccpResource.addRemoteSpc(0, SERVET_SPC, 0, 0);
        this.sccpResource.addRemoteSsn(0, SERVET_SPC, SSN, 0, false);

        this.router.addMtp3ServiceAccessPoint(1, 1, CLIENT_SPC, NETWORK_INDICATOR, 0, null);
        this.router.addMtp3Destination(1, 1, SERVET_SPC, SERVET_SPC, 0, 255, 255);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ROUTING_INDICATOR=" + TestHarness.ROUTING_INDICATOR);
            ...
            if (args.length >= 19) {
            TestHarness.SENDING_MESSAGE_THREAD_COUNT = Integer.parseInt(args[18]);
        }

        System.out.println("SENDING_MESSAGE_THREAD_COUNT=" + TestHarness.SENDING_MESSAGE_THREAD_COUNT);
    ...
    public class DialogInitiator implements Runnable {
        ...
        public void run() {
            try {
                ...
                logger.error("Exception when sending of a new MAP dialog", ex);
            }
        }
